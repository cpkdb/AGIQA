...
DIMS="overexposure,color_cast,awkward_positioning,cluttered_scene,count_error,scale_inconsistency,illogical_colors,extra_objects,face_asymmetry,object_shape_error,body_proportion_error"
