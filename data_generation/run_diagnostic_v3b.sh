...
DIMS="overexposure,color_cast,scale_inconsistency,count_error,extra_objects,face_asymmetry,object_shape_error,illogical_colors,expression_mismatch,logo_symbol_error"
